            ...
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_harga/editharga')?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="code" name="code" value="<?php echo $harga->code; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="harga" name="harga" value="<?php echo number_format($harga->harga); ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Min. Kg</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="kg" name="kg" value="<?php echo number_format($harga->kg); ?>" onkeypress="return Angkasaja(event)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">T-L</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="tl" name="tl" value="<?php echo $harga->tl; ?>">
                  </div>
                </div>
               <?php } ?>
              </div>
